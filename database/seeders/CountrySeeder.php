...
class CountrySeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('countries')->insert([
            ...
            ["name" => "Brazil", "code" => "BR"],
            ["name" => "British Antarctic Territory", "code" => "AB"],
            ...
            ["name" => "Chad", "code" => "TD"],
            ["name" => "Chile", "code" => "CL"],
            ["name" => "China (People's Republic of)", "code" => "CN"],
            ["name" => "Christmas Island", "code" => "CX"],
            ["name" => "Clipperton", "code" => "CP"],
            ["name" => "Cocos Islands (or Keeling Islands)", "code" => "CC"],
            ...
            ["name" => "Kosovo * UN resolution", "code" => "XK"],
            ["name" => "Kuwait", "code" => "KW"],
