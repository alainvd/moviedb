<footer class="ecl-footer-harmonised ecl-footer-harmonised--group1">
  <div class="ecl-container ecl-footer-harmonised__container">
    ...
    <div class="ecl-footer-harmonised__section2">
      ...
      <section class="ecl-footer-harmonised__section">
        ...
        <ul class="ecl-footer-harmonised__list ecl-footer-harmonised__list--inline">
          <li class="ecl-footer-harmonised__list-item"><a href="/example" class="ecl-footer-harmonised__link ecl-link ecl-link--standalone ecl-link--icon ecl-link--icon-before" aria-label="Link to Facebook"><svg focusable="false" aria-hidden="true" class="ecl-link__icon ecl-icon ecl-icon--xs">
                <use xlink:href="/ecl-images/icons/sprites/icons.svg#branded--facebook"></use>
              </svg>&nbsp;<span class="ecl-link__label">Facebook</span></a></li>
          <li class="ecl-footer-harmonised__list-item"><a href="/example" class="ecl-footer-harmonised__link ecl-link ecl-link--standalone ecl-link--icon ecl-link--icon-before" aria-label="Link to Twitter"><svg focusable="false" aria-hidden="true" class="ecl-link__icon ecl-icon ecl-icon--xs">
                <use xlink:href="/ecl-images/icons/sprites/icons.svg#branded--twitter"></use>
              </svg>&nbsp;<span class="ecl-link__label">Twitter</span></a></li>
          <li class="ecl-footer-harmonised__list-item"><a href="/example" class="ecl-footer-harmonised__link ecl-link ecl-link--standalone ecl-link--icon ecl-link--icon-before" aria-label="Link to Linkedin"><svg focusable="false" aria-hidden="true" class="ecl-link__icon ecl-icon ecl-icon--xs">
                <use xlink:href="/ecl-images/icons/sprites/icons.svg#branded--linkedin"></use>
    ...
    <section class="ecl-footer-harmonised__section ecl-footer-harmonised__section8">
      <ul class="ecl-footer-harmonised__list">
        <li class="ecl-footer-harmonised__list-item"><a href="/example" class="ecl-footer-harmonised__link ecl-link ecl-link--standalone" aria-label="Link to Contact the European Commission">Contact the European Commission</a></li>
        <li class="ecl-footer-harmonised__list-item"><a href="/example" class="ecl-footer-harmonised__link ecl-link ecl-link--standalone ecl-link--icon ecl-link--icon-after" aria-label="Link to Follow the European Commission"><span class="ecl-link__label">Follow the European Commission on social media</span>&nbsp;<svg focusable="false" aria-hidden="true" class="ecl-link__icon ecl-icon ecl-icon--xs">
              <use xlink:href="/ecl-images/icons/sprites/icons.svg#ui--external"></use>
            </svg></a></li>
        <li class="ecl-footer-harmonised__list-item"><a href="/example" class="ecl-footer-harmonised__link ecl-link ecl-link--standalone" aria-label="Link to Resources for partners">Resources for partners</a></li>
      </ul>
    </section>
