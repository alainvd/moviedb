<div x-data="app()" x-init="[initDate(), getNoOfDays()]" x-cloak>
    <label for="{{ $id }}" class="block text-sm font-medium leading-5 text-gray-800">
        {{ $label }}
    </label>
    ...
    <div class="container mx-auto px-4 py-2 md:py-10">
        <div class="mb-5 w-64">
            ...
            <div class="relative">
                <input type="text" readonly x-model="datepickerValue" @click="showDatepicker = !showDatepicker"  class="w-full pl-4 pr-10 py-3 leading-none rounded-lg shadow-sm focus:outline-none focus:shadow-outline text-gray-600 font-medium" placeholder="Select date">
