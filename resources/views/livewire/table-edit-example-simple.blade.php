    ...
    <div>
        <x-table>
            ...
            <x-slot name="body">
                ...
                <x-table.row>
                    <x-table.cell class="text-center">{{ $producer_roles[$producer['role']] }}</x-table.cell>
                    <x-table.cell class="text-center">{{ $producer['name'] }}</x-table.cell>
                    <x-table.cell class="text-center">{{ $producer['city'] }}</x-table.cell>
                    <x-table.cell class="text-center">{{ $countries[$producer['country_id']]['name'] }}</x-table.cell>
                    <x-table.cell class="text-center">{{ $producer['share'] }}</x-table.cell>
                    <x-table.cell class="text-center">{{ $producer['budget'] }}</x-table.cell>
                    <x-table.cell class="text-center space-x-2">
                        <a wire:click="showModalEdit('{{ $producer['id'] }}')" class="cursor-pointer">Edit</a>
                        <a wire:click="showModalDelete('{{ $producer['id'] }}')" class="cursor-pointer">Delete</a>
                    </x-table.cell>
                </x-table.row>
                @endforeach
            </x-slot>
