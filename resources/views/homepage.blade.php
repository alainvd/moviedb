        ...
        <div class="my-4 p-4 md:w-1/2 sm:px-8 md:pl-16 md:pr-4 lg:pl-24 md:flex md:flex-col md:justify-center">
            ...
            <div>
                <div class="inline-block relative">
                    <select class="block appearance-none w-full px-3 py-3 pr-8 border-2 border-indigo-700 text-sm text-indigo-700 font-bold bg-white" name="call" id="call">
            ...
            <div class="mt-2">
                <div class="inline-block relative">
                    <input type="text" class="p-3 border-2 border-indigo-700 text-sm text-indigo-700 placeholder-indigo-700 font-bold" placeholder="enter your project ID">
                    <button type="button" class="p-3 mt-2 border-2 border-indigo-700 text-sm text-white font-bold bg-indigo-700">
