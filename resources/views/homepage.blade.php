            ...
            <form id="create-dossier-form" action="{{route('dossiers.create')}}" method="get">
                ...
                <div>
                    <div class="inline-block relative">
                        <select class="block appearance-none w-64 px-3 py-3 pr-8 border-2 border-indigo-700 text-sm text-indigo-700 font-bold bg-white" name="call_id" id="call_id" required>
